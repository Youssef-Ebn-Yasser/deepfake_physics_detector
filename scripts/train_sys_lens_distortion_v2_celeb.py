...
def main():
    ...
    # Train on Celeb-DF
    base_dir_train = os.path.join('DataSets', 'f1v2_features', 'celeb_df')
    ...
    print(f"Loading {feature_name} training features from Celeb-DF-v2...")
    ...
    evaluate_dataset(model, "Celeb-DF-v2 (Internal Val)", manifest_path_train, base_dir_train, feature_key, scaler)
    
    # Zero-shot cross-dataset evaluation on FF++ and Deepfakes
